...
Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Kalie.html
...
for i in range(count):
    ...
    # Check if we have enough tags and get the next URL
    if len(tags) >= position:
        url = tags[position-1].get('href', None)
    else:
        print('Position exceeds number of links')
        break
